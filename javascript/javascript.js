$(document).ready(function(){
	...
	function updateGif(array) {
		...
		for (var i = 0; i < array.length; i++) {
			...
			element.append('<div class="row"><div class="col s4 m4 offset-m4 offset-s4"><div class="card center-align"><div class="card-image"><img src="' + still + '"><a class="btn-floating halfway-fab waves-effect waves-light red"><i data-state="still" data-still='+ still +' data-animate='+ animate +' class="material-icons play">play_arrow</i></a></div><div class="card-content"><p>' + 'Rating: ' + rating + '</p></div></div></div></div>');
